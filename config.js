...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~d41741201ebaa71cb7e01c1dffe5e5bc:744d79732b527a6d794a493d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || '𝑲𝒆𝒌𝒆𝒕𝒔𝒐 𝑩𝒐𝒕;Skl11;0;https://i.imgur.com/P7ziVhr.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝑲𝒆𝒌𝒆𝒕𝒔𝒐 𝑩𝒐𝒕",
    BOT_NAME: process.env.BOT_NAME || '𝑲𝒆𝒌𝒆𝒕𝒔𝒐 𝑩𝒐𝒕',
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || '0fce0d68-a17d-41ef-b48b-0509f1c922f5',
        APP_NAME: process.env.HEROKU_APP_NAME || 'keketsobot'
    },
